...
function _getP5Instance() {
  return window._p5Instance || p5.instance ||  p5._pInst
}
...
class Riso extends p5.Graphics {
  constructor(channelColor, w, h) {
    ...
    // console.log(p5._pInst)
    // console.log(p5._pInst.__proto__)
    let pPrototype=p5._pInst.__proto__

    this._fill = pPrototype.fill.bind(this);
    this._stroke = pPrototype.stroke.bind(this);
    this._image = pPrototype.image.bind(this);
